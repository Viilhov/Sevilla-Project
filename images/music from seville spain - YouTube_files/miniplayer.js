(function(g){var window=this;'use strict';var Fib=function(a,b){g.W.call(this,{G:"button",La:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},X:[{G:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},X:[{G:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},X:[{G:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
X:[{G:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.I=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.wT(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.sb(this,g.qT(b.Dc(),this.element))},Gib=function(a){g.W.call(this,{G:"div",
S:"ytp-miniplayer-ui"});this.qg=!1;this.player=a;this.T(a,"minimized",this.ai);this.T(a,"onStateChange",this.SP)},Hib=function(a){g.fU.call(this,a);
this.u=new g.iK(this);this.j=new Gib(this.player);this.j.hide();g.eT(this.player,this.j.element,4);a.Vf()&&(this.load(),g.Bq(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(Fib,g.W);Fib.prototype.onClick=function(){this.I.Qa("onExpandMiniplayer")};g.x(Gib,g.W);g.k=Gib.prototype;
...
a=new Fib(this.player,this);g.E(this,a);a.Ha(this.Zj.element);this.Uu=new g.W({G:"div",S:"ytp-miniplayer-controls"});g.E(this,this.Uu);this.Uu.Ha(this.Zj.element);this.T(this.Uu.element,"click",this.vH);var b=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.E(this,b);b.Ha(this.Uu.element);a=new g.W({G:"div",S:"ytp-miniplayer-play-button-container"});g.E(this,a);a.Ha(this.Uu.element);var c=new g.W({G:"div",S:"ytp-miniplayer-button-container"});g.E(this,c);c.Ha(this.Uu.element);this.xX=new g.NV(this.player,
...
g.k.ZA=function(){};
g.k.xs=function(){};
g.k.LD=function(){};g.x(Hib,g.fU);g.k=Hib.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Bq(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.eU("miniplayer",Hib);})(_yt_player);

(function(g){var window=this;'use strict';var wib=function(a){g.W.call(this,{G:"div",S:"ytp-inline-preview-ui"});this.qg=!1;this.player=a;this.T(a,"onStateChange",this.SP);this.T(a,"videodatachange",this.Jw);this.T(a,"onInlinePreviewModeChange",this.I4);this.wf=new g.nq(this.Vv,null,this);g.E(this,this.wf)},I6=function(a){g.fU.call(this,a);
this.j=new wib(this.player);g.E(this,this.j);this.j.hide();g.eT(this.player,this.j.element,4);a.isInline()&&(this.load(),a=a.getRootNode(),g.yq(a,["ytp-inline-preview-mode","ytp-no-contextmenu"]))};
g.x(wib,g.W);g.k=wib.prototype;
